...
const getList = (item) => __awaiter(void 0, void 0, void 0, function* () {
    let value;
    try {
        const { data } = yield axios_1.default.get(`https://geo.datav.aliyun.com/areas_v3/bound/${item.adcode}_full.json`);
        value = data;
    ...
    try {
        yield write(`./geo/${item.name}.json`, JSON.stringify(value));
